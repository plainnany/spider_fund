...
class ToCSVPipeline(object):
    def __init__(self):
        ...
        self.fieldnames = ["code", "name", "service_Charge", "purchase_amount","recent1Week", "recent1Month", "recent3Month", "recent6Month",
                           "recent1Year","recent2Year", "recent3Year","recent5Year", "from_Build", "type", "fund_scale", "establishment_date", "company"]
